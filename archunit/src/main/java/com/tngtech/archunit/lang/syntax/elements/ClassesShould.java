...
public interface ClassesShould
        extends AccessorShould<ClassesShouldConjunction>,
        AccessibleShould<ClassesShouldConjunction> {
     ...
     *
     * NOTE: 'depends' catches wide variety of violations, e.g. having fields of type, having method parameters of type, extending type etc...
     * Compare with {@link #onlyBeAccessed()}.{@link BeAccessedSpecification#byClassesThat(DescribedPredicate) byClassesThat(DescribedPredicate)}
